...
export const useControlButton = () => {
    ...
    }, [selectedItem, paper, addOrRemoveTransform]);
    ...
    }, [selectedItem, paper, stackOrder, elementActive, dispatch]);
    ...
    }, [selectedItem, paper, currentFtRef, dispatch, setElementActive, historyDispatch, setIsShowError, elementActive]);
