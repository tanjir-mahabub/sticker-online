...
const PriceCartBtn = () => {
    ...
    return (
        <>
            ...
            <button className="bg-so-orange hover:bg-so-orange/90 text-xs xl:text-base font-bold text-white px-3 xl:px-7 py-1.5 md:py-3 rounded shadow-md shadow-so-orange/50 hover:shadow-so-orange/70 transition-all duration-300">Lägg i kundvagnen</button>
        </>
    )
}
