        ...
        <>
            ...
            >
                ...
                <svg className="block lg:hidden" width="22" height="10" viewBox="0 0 22 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.25488 2.49902V8.49902H7.25488" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M20.7449 7.49885C20.2377 6.06564 19.3757 4.78426 18.2394 3.77427C17.1031 2.76429 15.7294 2.05862 14.2466 1.72311C12.7638 1.38761 11.2201 1.4332 9.75969 1.85563C8.29926 2.27806 6.96963 3.06357 5.89488 4.13885L1.25488 8.49885" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            >
                ...
                <svg className="block lg:hidden" width="23" height="10" viewBox="0 0 23 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21.2451 2.49902V8.49902H15.2451" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1.75488 7.49885C2.26205 6.06564 3.12402 4.78426 4.26035 3.77427C5.39668 2.76429 6.77035 2.05862 8.25317 1.72311C9.73599 1.38761 11.2796 1.4332 12.7401 1.85563C14.2005 2.27806 15.5301 3.06357 16.6049 4.13885L21.2449 8.49885" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
