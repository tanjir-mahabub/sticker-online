    ...
    return (
        <div className="relative w-full">
            <select
                id="material"
                name="material"
                className="mt-1 px-2 lg:px-3.5 py-3 bg-so-gray border border-gray-300 rounded-md min-w-60 w-full focus:outline-none focus:ring focus:border-blue-300 text-xs lg:text-sm"
