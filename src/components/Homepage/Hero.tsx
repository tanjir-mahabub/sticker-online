...
export default function Hero() {
  return <section className="studio-hero">
    ...
    <div className="hero-copy">
      <p className="studio-eyebrow"><span />Browser-based sticker design engine</p>
      ...
      <div className="hero-proof"><div><strong>10+</strong><span>editing tools</span></div><div><strong>5</strong><span>material finishes</span></div><div><strong>∞</strong><span>creative outcomes</span></div></div>
    </div>
    <div className="hero-visual" aria-label="Sticker editor preview">
      ...
      <div className="floating-tool floating-tool-one"><span>#F98332</span><strong>Die-cut border</strong></div><div className="floating-tool floating-tool-two"><span>✓</span><strong>Print ready</strong></div>
    </div>
  </section>;
}
