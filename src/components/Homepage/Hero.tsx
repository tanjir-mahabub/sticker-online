...
export default function Hero() {
  return <section className="studio-hero">
    <div className="hero-orb hero-orb-one" /><div className="hero-orb hero-orb-two" /><span className="hero-stamp">Made for<br/>makers ✦</span>
    <div className="hero-copy">
      ...
      <div className="hero-actions"><Link className="hero-primary" href="/editor">Start designing <span>→</span></Link><a className="hero-secondary" href="#features">See what it can do</a></div>
    ...
    <div className="hero-visual" aria-label="Sticker editor preview"><div className="preview-shell">
      ...
      </div><div className="floating-tool tool-one"><span>#FF6B35</span><strong>Die-cut border</strong></div><div className="floating-tool tool-two"><span>✓</span><strong>Print ready</strong></div><span className="preview-sticker-label">Drag · design · print</span></div>
  </section>;
}
